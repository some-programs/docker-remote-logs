...
const state: State = {
  autoscroll: (document.getElementById("autoscroll") as HTMLInputElement).checked,
  wraplines: (document.getElementById("wraplines") as HTMLInputElement).checked,
  timestamps: (document.getElementById("timestamps") as HTMLInputElement).checked,
  ts_low: null,
  ts_high: null
};
...
function buttonState(name: "autoscroll" | "wraplines" | "timestamps") {
